...
class CourseMediaTest(TestCase):
    ...
    def test_create_course_media(self, mock_method):
        ...
        response = test_app.post("/courses/"+str(global_course_id)+"/media/",
    ...
    def test_get_all_media(self, mock_method):
        ...
        response = test_app.get("/courses/"+str(global_course_id)+"/media/",
                                headers = header)
        response_json = response.json()
    ...
    def test_delete_media(self, mock_method_delete, mock_method_get):
        ...
        response = test_app.delete("/courses/"+str(global_course_id)+"/media/"+str(global_media_id),
                                    headers = header)
        response_json = response.json()
